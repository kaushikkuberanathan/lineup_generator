 ...
 *   Title:            Text with raw passthroughs for size/color — token
 *                     coverage gap flagged (color #374151 and size 15px
 *                     lack token equivalents)
 *
 * Props:
...
export function EmptyState({ hasQuery, onCreateTeam }) {
  return (
    <Stack direction="col" align="center" gap="sm" style={{ textAlign:"center", padding:"36px 16px" }}>
      ...
      <Text family="serif" weight="bold" size="15px" color="#374151" style={{ marginTop:"4px" }}>
