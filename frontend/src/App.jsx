                          ...
                          <div key={grp} style={{ marginBottom:"10px" }}>
                            ...
                            <div>
                              {keysInGroup.map(function(key) {
                                ...
                                return <span key={key} style={S.badge(s.color, active)} onClick={function(k) { return function() { updatePlayer(info.name, { skills: toggle(sk, k) }); }; }(key)}>{s.label}</span>;
                              })}
                            </div>
                          </div>
                        );
                            ...
                            <div key={grp} style={{ marginBottom:"8px" }}>
                              ...
                              <div>
                                {keysInGroup.map(function(key) {
                                  ...
                                  return <span key={key} style={S.badge(t.color, active)} onClick={function(k) { return function() { updatePlayer(info.name, { tags: toggle(tg, k) }); }; }(key)}>{t.label}</span>;
                                })}
                              </div>
                            </div>
                          );
                    ...
                    <div style={{ borderTop:"1px solid rgba(15,31,61,0.08)", paddingTop:"10px", marginBottom:"10px" }}>
                      ...
                      <div>
                        {batKeys.map(function(key) {
                          ...
                          return <span key={key} style={S.badge(b.color, active)} onClick={function(k) { return function() { updatePlayer(info.name, { batSkills: toggle(bs, k) }); }; }(key)}>{b.label} {b.bonus > 0 ? "+"+b.bonus : b.bonus}</span>;
                        })}
                      </div>
                    </div>
