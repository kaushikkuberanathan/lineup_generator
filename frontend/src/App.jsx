...
var SKILLS = {
  // Fielding Ability
  strongArm:      { label:"Strong Arm",       group:"Fielding",    color:"#27ae60", weights:{ P:18,SS:16,"3B":15,"2B":13,CF:12,"1B":8,LF:7,RF:7,C:6 } },
  goodGlove:      { label:"Good Glove",       group:"Fielding",    color:"#27ae60", weights:{ SS:18,"2B":16,"3B":14,"1B":12,CF:10,C:8,P:6,LF:5,RF:5 } },
  accurateThrower:{ label:"Accurate Throw",   group:"Fielding",    color:"#27ae60", weights:{ P:16,SS:14,"3B":13,"2B":11,CF:10,"1B":6,LF:5,RF:5,C:8 } },
  quickRelease:   { label:"Quick Release",    group:"Fielding",    color:"#27ae60", weights:{ C:18,SS:14,"2B":13,"3B":10,P:12,"1B":7,CF:8,LF:4,RF:4 } },
  naturalCatcher: { label:"Natural Catcher",  group:"Fielding",    color:"#7f8c8d", weights:{ C:22,"1B":10,"3B":6,SS:4,"2B":4,P:4,LF:2,CF:1,RF:2 } },
  bigKid:         { label:"Big/Strong",       group:"Fielding",    color:"#7f8c8d", weights:{ "1B":20,C:14,"3B":12,LF:8,RF:8,"2B":5,SS:3,CF:4,P:6 } },
  leftHanded:     { label:"Left Handed",      group:"Fielding",    color:"#7f8c8d", weights:{ "1B":22,LF:14,P:12,CF:10,RF:10,"3B":2,"2B":1,SS:1,C:1 } },
  // Game IQ
  gameAware:      { label:"Knows Where to Throw", group:"Game IQ", color:"#27ae60", weights:{ P:20,SS:18,"2B":10,"3B":9,"1B":7,C:4,CF:3,LF:1,RF:1 } },
  callsForBall:   { label:"Calls for Ball",   group:"Game IQ",     color:"#27ae60", weights:{ CF:18,SS:14,"2B":12,"3B":10,P:10,C:6,"1B":4,LF:8,RF:8 } },
  backsUpPlays:   { label:"Backs Up Plays",   group:"Game IQ",     color:"#27ae60", weights:{ P:14,CF:13,SS:12,"2B":10,"3B":8,"1B":6,C:4,LF:6,RF:6 } },
  // Effort and Behavior
  highEnergy:     { label:"High Energy",      group:"Effort",      color:"#27ae60", weights:{ P:14,SS:13,CF:13,"2B":11,"3B":10,"1B":8,C:8,LF:5,RF:5 } },
  hustles:        { label:"Hustles Always",   group:"Effort",      color:"#27ae60", weights:{ CF:12,SS:11,"2B":10,"3B":9,P:8,"1B":7,C:6,LF:7,RF:7 } },
  developing:     { label:"Developing",       group:"Effort",      color:"#d4a017", weights:{ LF:16,RF:16,C:14,CF:12,"1B":6,"2B":3,"3B":3,SS:1,P:1 } },
  // Base Running
  fastRunner:     { label:"Fast Runner",      group:"Base Running",color:"#27ae60", weights:{ CF:20,SS:16,"2B":14,LF:10,RF:10,P:8,"3B":7,"1B":5,C:2 } },
  smartOnBases:   { label:"Smart on Bases",   group:"Base Running",color:"#27ae60", weights:{ SS:12,CF:11,"2B":10,"3B":8,P:8,"1B":6,LF:7,RF:7,C:4 } },
  // Legacy key preserved for backward compatibility with saved rosters
  needsRoutine:   { label:"Needs Routine (Legacy)", group:"Fielding", color:"#d4a017", weights:{ "1B":16,RF:14,LF:14,C:8,"3B":6,CF:6,"2B":5,SS:3,P:2 } }
};
...
var TAGS = {
  ...
  fearfulOfBall:        { label:"Fearful of Ball",  group:"Confidence",   color:"#c8102e", mods:{ LF:10,RF:10,"1B":5,CF:-2,C:-14,P:-14,SS:-8,"2B":-6,"3B":-8 } },
  hesitates:            { label:"Hesitates",        group:"Confidence",   color:"#d4a017", mods:{ P:-10,SS:-8,C:-8,CF:-4,"2B":-4,"3B":-4,"1B":4,LF:6,RF:6 } },
  // Effort and Behavior (coach-observed)
  goodCoachability:     { label:"Coachable",        group:"Behavior",     color:"#27ae60", mods:{ P:4,SS:3,C:4,"2B":4,"3B":4,"1B":4,CF:3,LF:3,RF:3 } },
  inconsistentAttention:{ label:"Needs Focus",      group:"Behavior",     color:"#d4a017", mods:{ RF:8,LF:8,"1B":5,P:-12,SS:-10,C:-8,CF:-4,"2B":-4,"3B":-4 } },
  // Physical / Throwing
  weakThrower:          { label:"Weak Thrower",     group:"Physical",     color:"#c8102e", mods:{ P:-16,SS:-12,"3B":-10,"2B":-6,"1B":5,LF:5,RF:5,CF:-2,C:-4 } },
  slowRunner:           { label:"Slow Runner",      group:"Physical",     color:"#d4a017", mods:{ "1B":8,C:5,LF:3,RF:3,CF:-8,SS:-5,"2B":-3,"3B":-2,P:-1 } },
  // Base Running coaching
  needsBaseCoaching:    { label:"Needs Base Coaching", group:"Base Running", color:"#d4a017", mods:{ SS:-2,"2B":-2,CF:-2,P:-2,"3B":-1,"1B":4,LF:3,RF:3,C:2 } },
  // Lineup control
    ...
    try {
        ...
        if (printOpt === "both" || printOpt === "defense") {
          ...
          if (printDefView === "diamond") {
            ...
            var posLayoutPDF = [
              { pos:"CF", label:"Center Field",  cx:14,  cy:y },
              { pos:"LF", label:"Left Field",    cx:14,  cy:y + 46 },
              { pos:"SS", label:"Shortstop",     cx:68,  cy:y + 46 },
              { pos:"2B", label:"2nd Base",      cx:120, cy:y + 46 },
              { pos:"RF", label:"Right Field",   cx:174, cy:y + 46 },
              { pos:"3B", label:"3rd Base",      cx:14,  cy:y + 92 },
              { pos:"P",  label:"Pitcher",       cx:94,  cy:y + 92 },
              { pos:"1B", label:"1st Base",      cx:174, cy:y + 92 },
              { pos:"C",  label:"Catcher",       cx:94,  cy:y + 138 }
            ];
            // CF centered
            posLayoutPDF[0].cx = 94;
