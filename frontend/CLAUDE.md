...
- **Framework**: Vitest
- **CI target**: **1520 frontend passed / 0 failed across 137 test files** (backend unit 295 — see `backend/CLAUDE.md` § Test Suite), after `playerMapper.test.js` closed #945 (34 new tests, QA Coverage Scope #965). Prior baseline was 1486/136 on final v3.1.0 candidate `1da474e`.
