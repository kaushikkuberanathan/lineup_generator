...
- **Framework**: Vitest
- **CI target**: **1489 frontend passed / 0 failed across 137 test files** (backend unit 295 — see `backend/CLAUDE.md` § Test Suite). Baseline was 1486/136 on final v3.1.0 candidate `1da474e` after the #942 fairness fix and PR #956 coverage sweep; +3/+1 from `AppPwaInstallPrompt.test.jsx` (#968).
