...
Unit suite total: **220** (verified via `npm run test:unit`, 2026-08-25, #337 approve-link HMAC signing — 0 fail / 0 skipped; up from 199 same day, +21 from three new files below). Story 99 closed 2026-07-31; see ROADMAP.md Story 99 for the closure writeup.
