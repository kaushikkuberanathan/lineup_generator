...
Unit suite total: **232** (verified via `npm run test:unit`, 2026-08-26, #406/#410 test-health survey follow-up — up from 227, +5: `requireAdmin.test.js` (4, new file) + 1 new legacy-role case in `auth.session.test.js`, closing two untested-assumption findings from the survey's Pass 2). Story 99 closed 2026-07-31; see ROADMAP.md Story 99 for the closure writeup.
