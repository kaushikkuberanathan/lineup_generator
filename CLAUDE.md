...
**🔒 DEV/DEPLOY FREEZE in effect (declared 2026-08-23 ~21:50 EDT by KK):** do not merge any PR into `develop` (auto-deploys `dev.dugoutlineup.com`) and do not apply any migration to DEV or PROD Supabase, until either the v2.13.0 soak clears (2026-08-24 19:35 EDT) with KK's go-ahead, or it's confirmed v2.13.0 is actually live on `main`/PROD. Full scope and reasoning: `docs/product/ROADMAP.md` § v2.13.0 entry.
