...
## Test Suite
Changes to `lineupEngineV2.js`, `scoringEngine.js`, or `playerMapper.js` → must pass frontend `npm test` (Vitest, 975 passing / 1 skipped — fewer may be observed locally on Windows due to Bug #7 cold-start flake).
