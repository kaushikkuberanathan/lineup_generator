...
## Test Suite
Changes to `lineupEngineV2.js`, `scoringEngine.js`, or `playerMapper.js` → must pass frontend `npm test` (Vitest, **1543 passing across 144 files** on the frozen pre-v3.1.1 candidate `34ff2b2`, 2026-08-31 — fewer may be observed locally on Windows due to Bug #7 cold-start flake). Backend unit suite is **299/299** (see `backend/CLAUDE.md` § Test Suite).
