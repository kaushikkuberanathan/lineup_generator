...
## Test Suite
Changes to `lineupEngineV2.js`, `scoringEngine.js`, or `playerMapper.js` → must pass frontend `npm test` (Vitest, 1084 passing / 1 skipped as of v2.11.0 — fewer may be observed locally on Windows due to Bug #7 cold-start flake).
