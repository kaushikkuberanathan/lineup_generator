...
## Test Suite
Changes to `lineupEngineV2.js`, `scoringEngine.js`, or `playerMapper.js` → must pass frontend `npm test` (Vitest, 1368 passing / 1 skipped as of v2.15.0-prep, 2026-08-26 — fewer may be observed locally on Windows due to Bug #7 cold-start flake). This line had sat at the stale v2.12.0-era 1090 figure through multiple subsequent releases — flagged as a carry-forward in the 2026-08-24-B and 2026-08-26-A session retros before finally being corrected here.
