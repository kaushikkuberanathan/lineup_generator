...
10. [ ] Run `npm test` — confirm 551 passed / 1 skipped (as of v2.6.0, May 7, 2026) / 0 failed
...
- COMBINED_GAMEMODE_AND_SCORING — GA default-on as of Slice 3 (v2.6.0). Legacy ScoringMode and its Scoring tab removed. DugoutView is now the sole game-day surface. See `docs/SOLUTION_DESIGN.md` § Feature Flag System for full architectural history.
...
## Current Version
**v2.6.0** — May 2026. Full version history in `VERSION_HISTORY` constant in `frontend/src/data/versionHistory.js`.

- v2.6.0 (2026-05-07): Slice 3 — COMBINED_GAMEMODE_AND_SCORING flipped default-ON; legacy ScoringMode import + render block + Scoring tab removed; DUGOUT VIEW is now sole game-day launcher; ViewerMode share-link path simplified to DugoutView isViewer=true.
...
- Recent: Slice 0 (v2.5.4), Slice 1 (v2.5.5), Slice 2 (v2.5.7), Slice 3 (v2.6.0)
