...
- **Issue** | [#579](https://github.com/kaushikkuberanathan/lineup_generator/issues/579) — recommend leaving open or retitling to track the LoginScreen wiring follow-up rather than closing outright.
