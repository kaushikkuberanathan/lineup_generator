...
> Owner: KK | Last updated: 2026-05-13 (v2.5.11 — multi-PR release: Slice 4 cleanup + UX Phase 3 Step 2 + docs catchup; rows #8 + #11 + #28 notes refreshed)
