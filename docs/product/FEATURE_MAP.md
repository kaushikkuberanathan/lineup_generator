...
| 38 | **Request Access / Team Discovery** | MVP | `docs/product/AUTH_SECURITY_AUDIT_ROADMAP.md` § The label layer | ✅ Current | `RequestAccessScreen.test.jsx` (13), `TeamSearch.test.jsx` (8), `useAuth.requestAccess.test.js` (5), backend `teamsSearch.route.test.js` (9) | ✅ Yes | Story 124/#655. Touches `TeamSearch.jsx`, `RequestAccessScreen.jsx`, `useAuth.js` (`requestAccess` `preserveSession` option), backend `GET /api/v1/teams/search`. |
